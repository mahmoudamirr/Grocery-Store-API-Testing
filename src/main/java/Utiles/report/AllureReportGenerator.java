...
import Utiles.OSUtils;
import Utiles.TerminalUtils;
import Utiles.TimeManager;
...
import static Utiles.dataReader.PropertyReader.getProperty;
import static Utiles.report.AllureConstants.HISTORY_FOLDER;
import static Utiles.report.AllureConstants.RESULTS_HISTORY_FOLDER;
...
public class AllureReportGenerator {
    ...
    public static String renameReport() {
        ...
        Utiles.FileUtils.renameFile(AllureConstants.REPORT_PATH.resolve(AllureConstants.INDEX_HTML).toString(), newFileName);
        return newFileName;
    }
